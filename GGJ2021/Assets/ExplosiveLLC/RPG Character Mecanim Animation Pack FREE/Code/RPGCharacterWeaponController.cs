    ...
    public class RPGCharacterWeaponController : MonoBehaviour
    {
        ...
        private void DoWeaponSwitch(int weaponSwitch, int weaponVisibility, int weaponNumber, int leftRight, bool sheath)
        {
            ...
            if (sheath) {
                ...
                if (rpgCharacterController.ikHands != null) { StartCoroutine(rpgCharacterController.ikHands._BlendIK(false, 0f, 0.2f, weaponVisibility)); }
            } else {
                ...
                // If using IKHands, trigger IK blend.
                if (rpgCharacterController.ikHands != null) { StartCoroutine(rpgCharacterController.ikHands._BlendIK(true, 0.75f, 1, weaponVisibility)); }
            }
        }
