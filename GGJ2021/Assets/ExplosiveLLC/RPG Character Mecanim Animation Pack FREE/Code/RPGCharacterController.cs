...
namespace RPGCharacterAnimsFREE
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
			...
			// Aiming.
            if (isAiming) { Aim(isAiming, aimInput); }
        }
        ...
        public void Aim(bool aiming, Vector3 target)
        {
        ...
        /// </summary>
        /// <param name="direction">1- Backwards, 2- Backward version2, 3- Forwards.</param>
		...
		public void SetIKPause(float pauseTime)
		{
			if (ikHands != null && ikHands.isUsed) {
				StartCoroutine(ikHands._SetIKPause(pauseTime));
			}
		}
